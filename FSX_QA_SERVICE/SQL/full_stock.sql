...
-- ----------------------------
DROP TABLE IF EXISTS `FullStockRecord`;
CREATE TABLE `FullStockRecord` (
...
) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='全股测试模块';
