...
class Application(fix.Application):
    ...
    def load_test_case(self, account):
        """Run"""
        with open('/Users/zhenghuaimao/Desktop/FSX-DEV-QA/FSX_QA_SERVICE/edp_fix_client/initiator/edp_performance_test/uat_test_with_hrt.json', 'r') as f_json:
    ...
    def read_config(self, Sender, Target, Host, Port):
        ...
        config.read('/Users/zhenghuaimao/Desktop/FSX-DEV-QA/FSX_QA_SERVICE/edp_fix_client/initiator/edp_performance_test/edp_performance_client.cfg')
        config.set('SESSION', 'SenderCompID', Sender)
        config.set('SESSION', 'TargetCompID', Target)
        config.set('SESSION', 'SocketConnectHost', Host)
        config.set('SESSION', 'SocketConnectPort', Port)

        with open('/Users/zhenghuaimao/Desktop/FSX-DEV-QA/FSX_QA_SERVICE/edp_fix_client/initiator/edp_performance_test/edp_performance_client.cfg', 'w') as configfile:
...
def main():
    try:
        ...
        settings = fix.SessionSettings("/Users/zhenghuaimao/Desktop/FSX-DEV-QA/FSX_QA_SERVICE/edp_fix_client/initiator/edp_performance_test/edp_performance_client.cfg")
